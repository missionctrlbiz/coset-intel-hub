    ...
    metrics: [
      {
        ...
        value: "68%",
        note: "Composite readiness score across six pilot states.",
      },
      {
        label: "Capex Efficiency",
        value: "31%",
        note: "Projected savings under distributed deployment.",
      },
    ],
  },
];
...
export const blogPosts = [
  {
    title: "After COP28: what climate finance means for communities in Nigeria",
    excerpt:
      "A CoSET reading of post-COP28 finance commitments, with a focus on justice, accountability, and the realities facing frontline communities.",
    category: "Policy Update",
    publishedAt: "Nov 24, 2024",
    author: "CoSET Editorial Desk",
    image: "/coset-eye-banner.jpg",
  },
  {
    title:
      "Gas flaring, public health, and the case for stronger enforcement in the Niger Delta",
    excerpt:
      "Why gas flaring remains a socio-ecological justice issue and what stronger regulation should mean for affected communities.",
  ...
  {
    title:
      "Renewable transition and livelihoods: questions policy makers should be asking",
    excerpt:
      "A practical reflection on energy transition planning, livelihoods, and the policy trade-offs shaping equitable change in Nigeria.",
    category: "Energy Transition",
    publishedAt: "Nov 02, 2024",
    author: "CoSET Policy Team",
    image: "/CoSET-5-600x540.png",
  },
];
...
export const filterGroups = {
  ...
  tags: ["Niger Delta", "Gas Flaring", "Policy Brief", "Community Resilience"],
